...
export default function Resume() {
  ...
  return (
    <section 
      ...
      className="border border-gray-700 hover:border-blue-400 rounded-2xl px-6  py-10 sm:py-11 flex items-center justify-between resume-fade-in duration-300 group cursor-pointer"
    >
