...
export default function TechStack() {
  ...
  return (
    <section className="mb-1 relative overflow-hidden border border-gray-700 rounded-2xl bg-[#0a0a0a] p-6 col-span-1 space-y-4 group tech-stack-fade-in cursor-pointer">
      {/* Header */}
